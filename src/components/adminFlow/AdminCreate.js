...
class AdminCreate extends Component {
  ...
  renderImageSelection() {
    ...
    return (
      <Button onPress={this.onImageButtonPress.bind(this)}>Select Image</Button>
    );
  }
        ...
        <Card>
          <CardSection>
            <Input
              ...
              onChangeText={text =>
                this.props.adminUpdate({ prop: "title", value: text })
              }
            />
          </CardSection>
          ...
          <CardSection>
            <Input
              ...
              onChangeText={text =>
                this.props.adminUpdate({ prop: "dateTime", value: text })
              }
            />
          </CardSection>
          ...
          <CardSection>
            <Input
              ...
              onChangeText={text =>
                this.props.adminUpdate({ prop: "venue", value: text })
              }
            />
          </CardSection>
          ...
          <CardSection>
            <Input
              ...
              onChangeText={text =>
                this.props.adminUpdate({ prop: "description", value: text })
              }
            />
          </CardSection>
          ...
          <CardSection>{this.renderImageSelection()}</CardSection>
